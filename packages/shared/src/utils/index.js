...
function isValidCPF(cpf) {
    ...
    if (remainder === 10)
        remainder = 0;
    if (remainder !== Number.parseInt(digits.charAt(9), 10))
        return false;
    // Second check digit
    sum = 0;
    for (let i = 0; i < 10; i++) {
    ...
    if (remainder === 10)
        remainder = 0;
    if (remainder !== Number.parseInt(digits.charAt(10), 10))
        return false;
    return true;
}
/**
